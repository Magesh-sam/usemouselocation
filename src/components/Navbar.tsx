...
function Navbar() {
  return (
      <nav className="flex px-5 py-3   fixed top-0 w-full bg-gray-800">
          <ul className="flex flex-1 justify-between ">
              <li className="cursor-pointer">
                  <a className="text-lg " href="/" >useMouseLocation</a>
              </li>
              <li>
                  <a  href="https://github.com/Magesh-sam/use-mouse-location" target="_blank" className="flex gap-2 items-center text-lg hover:underline underline-offset-4 " ><span>GitHub</span>
                  <svg
